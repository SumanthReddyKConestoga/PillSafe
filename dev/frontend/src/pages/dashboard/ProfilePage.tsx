...
import { Pencil, Pill, ScanLine, Calendar, KeyRound } from 'lucide-react';
    ...
    <div className="space-y-6 page-enter max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card padding="sm" className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xl font-bold text-slate-900">{patient.medications_analyzed}</p>
            <p className="text-xs text-slate-500">Medications Analyzed</p>
          </div>
        </Card>
        <Card padding="sm" className="flex items-center gap-3">
        ...
        <Card padding="sm" className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xl font-bold text-slate-900">
              {patient.last_scan_at ? new Date(patient.last_scan_at).toLocaleDateString() : '—'}
            </p>
